...
namespace ContactWeb.Controllers
{
    public class StatesController : Controller
    {
        ...
        public StatesController(MyContactManagerDataDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.States != null ? 
                          ...
                          Problem("Entity set 'MyContactManagerDataDbContext.States'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MyContactManagerDataDbContext.States'  is null.");
            }
            var state = await _context.States.FindAsync(id);
            if (state != null)
            {
